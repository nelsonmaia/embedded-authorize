...
| `npm test` | 223 assertions: data fidelity, the state machine, transports, proxy guards + log hygiene |
...
| `node tests/e2e-browser.mjs` | 71 browser checks over CDP. Needs `npm run dev` running. |
